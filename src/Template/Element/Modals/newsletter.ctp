...
<div id="newsletterModal" class="modal">
    <div class="modal-content mg-padding-0">
		<div class="row mg-margin-0">
			...
			<div class="col s6 center" style="background:url('/img/assets/modals/newsletter/2.png');">
              ...
              <form class="mg-margin-top-30" name="newsletter_subscription" ng-submit="mainctrl.newsletter(newsletter)">
                ...
                <div class="col l12 s12 m12 mg-margin-top-0 mg-padding-0">
                     <button type="submit" ng-disabled="newsletter_subscription.$invalid || mainctrl.is_newsletter_subscribing" class="btn mg-height-49 orange white-text mg-padding-top-5 bold mg-width-100-perc">Je m'inscris à la newsletter</a>
                </div>
              </form>
