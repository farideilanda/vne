          ...
          <div class="container">
              ...
              <div class="col l3 s12 m12 mg-padding-left-0">
                <h5 class="orange-text">Restons connectés</h5>
                    ...
                    <a class="hvr-shrink" href="https://www.linkedin.com/company/11309570/" target="_blank">
                      <i class="ion-social-linkedin-outline medium orange-text mg-margin-right-20"></i>
                    </a>
                    <a class="hvr-shrink" href="https://twitter.com/VNEntreprise" target="_blank">
                      <i class="ion-social-twitter-outline medium orange-text mg-margin-right-20"></i>
                    </a>
						        
						        <i class="ion-social-skype-outline medium orange-text tooltipped hvr-shrink" data-tooltip="vne.business" data-position="top" data-delay="5s"></i>
	                </p>
            ...
            <div class="row">
              ...
              <form name="newsletter_subscription" ng-submit="mainctrl.newsletter(newsletter)">
                ...
                <div class="col l2 s12 m6 mg-margin-top-0 mg-padding-0">
                     <button type="submit" ng-disabled="newsletter_subscription.$invalid || mainctrl.is_newsletter_subscribing" class="btn mg-height-49 orange white-text mg-padding-top-5 bold mg-width-100-perc">Soumettre</a>
                </div>
              </form>
            </div>
