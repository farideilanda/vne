<div class="row left-align mg-padding-left-50">
	<?= $this->Html->image('assets/logo_solutions/windows_server.jpg',['class'=>'mg-width-190']) ?> <br>
	...
	<?= $this->Html->image('assets/partner/microsoft_partner.png',['class'=>'mg-width-190']) ?> <br> <br>
