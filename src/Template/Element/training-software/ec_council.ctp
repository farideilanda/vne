<div class="row left-align mg-padding-left-50" >
	<?= $this->Html->image('assets/partner/ec_council-2.png',['class'=>'mg-width-205']) ?> <br> <br>
    ...
    <br>
	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem quis assumenda sequi deserunt rerum commodi autem, quo iste, quos perferendis tempore facere ut modi omnis voluptas adipisci nam id ea.
	<br> <br>
	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem quis assumenda sequi deserunt rerum commodi autem, quo iste, quos perferendis tempore facere ut modi omnis voluptas adipisci nam id ea.
	<div class="col s12 left-align mg-padding-0">
			...
			<a href="#!" class="btn mg_sec_background_2 bold white-text mg-margin-top-20">Lire la brochure</a>
	</div>
</div>