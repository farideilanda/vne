...
<div class="row left-align mg-padding-left-50 white-text" >
	<?= $this->Html->image('assets/logo_solutions/msql_server.png',['class'=>'mg-width-200']) ?> <br>
    ...
    <br>
	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo eveniet tenetur non voluptates eos fugiat voluptatum veniam ratione ipsam impedit ad minima, cumque commodi. Dolorum officia quisquam quas alias nostrum. <br>
